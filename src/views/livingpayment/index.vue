<template>
	...
	>
		...
		<div class="wd-right-sidebar flex flex-col items-end gap-8">
			...
			></el-button>
			<el-button
				class="w-30! h-15! fw-700! opacity-80 color-red!"
				@click="router.back()"
				>返回</el-button
			>
		</div>
	...
	<!-- P2 -->
	<div
		v-show="stateNumber === 1 || stateNumber === 2"
		class="wd-box flex items-start w-full p-8! relative!"
	>
		<div class="wd-left-sidebar flex flex-col items-end gap-8">
			<el-button
			...
			<el-button
				class="w-30! h-15! fw-700! opacity-0 hover:cursor-default"
			></el-button>
			<el-button class="w-30! h-15! fw-700! opacity-80">确认</el-button>
		</div>
